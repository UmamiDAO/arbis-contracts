...
contract PPEGGUSDCStrategy is ERC20, AccessControl, IStrategy {
  ...
  IPair public depositToken;//ppegg/usdc
  ...
  constructor(
    ...
    depositToken = IPair(  0x239845B0f92C1Bcf1D0A030dE1e0211be8269D62);
    ...
    address _token1 = depositToken.token1();//usdc
    token0 = IERC20(_token0);
    token1 = IERC20(_token1);
    
    feeDestination =  0x2906c88AE542Deda106cB3E8E65071F99DBE1a95;//ppegg escrow
