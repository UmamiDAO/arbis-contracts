...
contract SWPRETHLPFarmStrategy is ERC20, AccessControl, IStrategy {
    ...
    IERC20 public rewardToken; //swpr
    ...
    constructor()
        ERC20("SWPR/ETH LP Epoch 3 Arbis Shares", "SWPR/ETH-SHARES")
    {
        depositToken = IPair(0xA66b20912cBEa522278f3056B4aE60D0d3EE271b);//swapr/eth lp
        rewardToken = IERC20(0xdE903E2712288A1dA82942DDdF2c20529565aC30); //arbis
        stakingContract = IERC20StakingRewardsDistribution(
              0xbF849BF34DE905996721c679679b82B1def5B2dE
        );
