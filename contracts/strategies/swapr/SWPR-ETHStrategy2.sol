...
contract SwaprLPFarmStrategy is ERC20, Ownable, IStrategy {
  ...
  constructor(
    ...
    depositToken = IPair(0xA66b20912cBEa522278f3056B4aE60D0d3EE271b);
    rewardToken = IERC20(0xdE903E2712288A1dA82942DDdF2c20529565aC30);
    stakingContract = IERC20StakingRewardsDistribution(0x2E6413ec518990bAa72dff2AD0e64dfDF28E88c7);
    router = IRouter(0x530476d5583724A89c8841eB6Da76E7Af4C0F17E);

    address _token0 = IPair(0xA66b20912cBEa522278f3056B4aE60D0d3EE271b).token0();
    address _token1 = IPair(0xA66b20912cBEa522278f3056B4aE60D0d3EE271b).token1();
